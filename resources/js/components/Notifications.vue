      ...
      <v-row>
        ...
        <v-col cols="10" md="11" align-self="center">
          <div v-if="notification.type == 'App\\Notifications\\Mentioned'">
            ...
            <a v-if="notification.data.from_model == 'wpis'" :href="`/#/mirko/${notification.data.from_model_id}`" class="text-decoration-none">tym wpisie</a> 
            <a v-if="notification.data.from_model == 'comment' && notification.data.comment_parent == 'wpis'" :href="`/#/mirko/${notification.data.from_model_id}`" class="text-decoration-none">tym komentarzu</a> 
